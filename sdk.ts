...
export class Client {
    ...
    getEventUserFinancialTimeline: ReturnType<typeof getEventUserFinancialTimeline>;
    ...
    private constructor(
        ...
        // Event Ticket Order / Refunds
        this.getEventUserFinancialTimeline = getEventUserFinancialTimeline(rest_api_url, getJwt);
