...
import {
    ...
    downloadCommunityMembersAndProspectsCsv,
    ...
    inviteCommunityMembersByContacts,
    inviteCommunityMembersCSV,
...
export class Client {
    ...
    // Personas
    getPersonas: ReturnType<typeof getPersonas>;
    updateUserPersonas: ReturnType<typeof updateUserPersonas>;

    // Stripe
    connectStripeAccount: ReturnType<typeof connectStripeAccount>;
    ...
    */
    ...
    inviteCommunityMembers: ReturnType<typeof inviteCommunityMembers>;
    inviteCommunityMembersByContacts: ReturnType<
        typeof inviteCommunityMembersByContacts
    >;
    ...
    >;
    downloadCommunityMembersAndProspectsCsv: ReturnType<
        typeof downloadCommunityMembersAndProspectsCsv
    >;
    ...
    private constructor(
        ...
        this._getPlace = getPlace(rest_api_url);
        ...
        this.putAnnouncementContent = putAnnouncementContent(rest_api_url, getJwt);
        this.republishAnnouncement = republishAnnouncement(rest_api_url, getJwt);
        ...
        // Personas
        this.getPersonas = getPersonas(rest_api_url);
        this.updateUserPersonas = updateUserPersonas(rest_api_url, getJwt);

        // Stripe
        this.connectStripeAccount = connectStripeAccount(rest_api_url, getJwt);
        ...
        this.inviteCommunityMembers = inviteCommunityMembers(rest_api_url, getJwt);
        this.inviteCommunityMembersByContacts = inviteCommunityMembersByContacts(
            rest_api_url,
            getJwt,
        );
        ...
        this.downloadCommunityMembersAndProspectsCsv = downloadCommunityMembersAndProspectsCsv(
            rest_api_url,
            getJwt,
        );
    ...
    // New: getPlace (alias for /place/{id})
    getPlace = async (args: { id: number }) => {
        const res = await this._getPlace(args);
        return res;
    };
